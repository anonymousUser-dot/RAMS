...
_NP_FLOAT128 = getattr(np, "float128", None)
_NP_COMPLEX256 = getattr(np, "complex256", None)
...
if _NP_FLOAT128 is not None:
    NUMPY_FLOAT_TYPECODES[_NP_FLOAT128] = "g"
...
if _NP_COMPLEX256 is not None:
    NUMPY_COMPLEX_TYPECODES[_NP_COMPLEX256] = "G"
...
if _NP_FLOAT128 is not None:
    NUMPY_FLOAT_TYPESTRINGS[_NP_FLOAT128] = "float128"
...
if _NP_COMPLEX256 is not None:
    NUMPY_COMPLEX_TYPESTRINGS[_NP_COMPLEX256] = "complex256"
...
if _NP_FLOAT128 is not None:
    NUMPY_DTYPES["float128"] = _NP_FLOAT128
if _NP_COMPLEX256 is not None:
    NUMPY_DTYPES["complex256"] = _NP_COMPLEX256
